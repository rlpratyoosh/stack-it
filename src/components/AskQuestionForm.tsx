...
export default function AskQuestionForm({ availableTags = [] }: AskQuestionFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-3 sm:p-4 lg:p-6">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Ask a Question</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 sm:py-2.5 border border-gray-300 dark:border-zinc-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 text-sm sm:text-base"
          />
          {errors.title && (
